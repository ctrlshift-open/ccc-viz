...
export function MobileNav() {
  ...
  // Listen for open-mobile-nav custom event
  useEffect(() => {
  ...
  return (
    <>
      ...
      {/* Slide-over menu */}
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-white dark:bg-gray-900 shadow-xl z-[70] transform transition-transform duration-300 ease-in-out md:hidden ${
